...
def play():
    ...
    head = tk.Button(menu, text="---Welcome to Jesvaan's tic-tac-toe---",
                     activeforeground='red',
                     activebackground="yellow", bg="red",
                     fg="yellow", width=500, height=2, font='summer', bd=5)

    B1 = tk.Button(menu, text="Single Player", command=wpc,
                   activeforeground='red',
                   activebackground="yellow", bg="red",
                   fg="yellow", width=500, height=2, font='summer', bd=5)
    ...
    B2 = tk.Button(menu, text="Multi Player", command=wpl, activeforeground='red',
                   ...
                   width=500, height=2, font='summer', bd=5)
